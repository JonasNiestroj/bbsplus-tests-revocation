use crate::accumulator::{
    ...
    Accumulator, Element, Error, MembershipWitness, SecretKey,
};
...
use super::utils::{AccParams, CredentialIndex, PublicKeys, SECURITY};
...
impl Witness {
    ...
    pub fn make_membership_proof(
        ...
        if !Self::ver(accumulator, public_keys, params, user_id, witness) {
            return [0; MembershipProof::BYTES];
        }
        // Create commitment
